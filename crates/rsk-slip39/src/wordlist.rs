...
//
// The canonical SLIP-0039 English wordlist (1024 words), generated from the
// reference `shamir_mnemonic` package's wordlist.txt and pinned by a SHA-256 test
// in lib.rs so a single edited/transposed word cannot slip in unnoticed. DO NOT
// edit by hand — regenerate from the canonical source.

/// The 1024 SLIP-39 words, indexed by their 10-bit value (`0..1024`).
